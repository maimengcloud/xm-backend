...
public class XmTask  implements java.io.Serializable {
	...
	@ApiModelProperty(notes="保障要求编号0-不限制，1铜牌，2银牌，3金牌",allowEmptyValue=true,example="",allowableValues="")
	String supRequires;
	...
	@ApiModelProperty(notes="0-草稿，1-正式",allowEmptyValue=true,example="",allowableValues="")
	String status;
	
	@ApiModelProperty(notes="供应商投标截止时间",allowEmptyValue=true,example="",allowableValues="")
	Date bidEtime;
	
	@ApiModelProperty(notes="服务编号-对应服务商中我的服务里面的服务编号",allowEmptyValue=true,example="",allowableValues="")
	String serviceId;
	
	@ApiModelProperty(notes="最低信用等级",allowEmptyValue=true,example="",allowableValues="")
	String creditId;
