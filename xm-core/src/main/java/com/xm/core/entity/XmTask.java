...
public class XmTask  implements java.io.Serializable {
	...
	@ApiModelProperty(notes="是否为热搜0否1是是否为置顶0否1是,每次热搜3天，3天后自动取消热搜",allowEmptyValue=true,example="",allowableValues="")
	String hot;
	
	@ApiModelProperty(notes="是否为置顶0否1是,每次置顶3天，3天后自动取消置顶",allowEmptyValue=true,example="",allowableValues="")
	String top;
