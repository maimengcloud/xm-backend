...
public class XmTask  implements java.io.Serializable {
	...
	@ApiModelProperty(notes="地域限制方式0-不限制，1-同城，2-同省，3-同国",allowEmptyValue=true,example="",allowableValues="")
	String regionType;
