...
public class XmTask  implements java.io.Serializable {
	...
	@ApiModelProperty(notes="任务状态0待领取1已领取执行中2已完工3已结算4已关闭5草稿",allowEmptyValue=true,example="",allowableValues="")
	String taskState;
	...
	@ApiModelProperty(notes="能力等级编号列表，逗号分割",allowEmptyValue=true,example="",allowableValues="")
	String capaLvls;
	...
	@ApiModelProperty(notes="是否为热搜0否1是",allowEmptyValue=true,example="",allowableValues="")
	String hot;
	
	@ApiModelProperty(notes="是否为置顶0否1是",allowEmptyValue=true,example="",allowableValues="")
	String top;
	
	@ApiModelProperty(notes="加急0否1是",allowEmptyValue=true,example="",allowableValues="")
	String urgent;
	
	@ApiModelProperty(notes="客服包办0否1是，理顺需求、比稿选稿",allowEmptyValue=true,example="",allowableValues="")
	String crmSup;
	
	@ApiModelProperty(notes="投标流程0-草稿，1-发布需求，2-用户投标，3雇主选标，4拓管赏金，5用户工作，6验收付款",allowEmptyValue=true,example="",allowableValues="")
	String bidStep;
	
	@ApiModelProperty(notes="会员等级编号列表，逗号分割",allowEmptyValue=true,example="",allowableValues="")
	String interestLvls;
