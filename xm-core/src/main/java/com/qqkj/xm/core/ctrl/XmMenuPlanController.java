...
import com.qqkj.xm.core.service.push.XmMenuPushMsgService;
import com.qqkj.xm.core.vo.XmMenuPlanVo;
...
public class XmMenuPlanController {
	...
	public Map<String,Object> addXmMenuPlan(@RequestBody XmMenuPlan xmMenuPlan) {
		...
		try{
			if(StringUtils.isEmpty(xmMenuPlan.getId())) {
				xmMenuPlan.setId(xmMenuPlanService.createKey("id"));
			}else{
				 XmMenuPlan xmMenuPlanQuery = new  XmMenuPlan(xmMenuPlan.getId());
				if(xmMenuPlanService.countByWhere(xmMenuPlanQuery)>0){
