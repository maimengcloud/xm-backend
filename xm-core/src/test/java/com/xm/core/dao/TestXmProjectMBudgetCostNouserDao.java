...
/**
 * XmProjectMBudgetCostNouserDao的测试案例
 * 组织 com.qqkj<br>
 * 顶级模块 oa<br>
 * 大模块 xm<br>
 * 小模块 <br>
 ...
 ***/
 ...
 @SpringBootTest
public class TestXmProjectMBudgetCostNouserDao  {
	...
	public void insert() {
		...
		baseDao.insert(xmProjectMBudgetCostNouser);
	...
	public void deleteByWhere() {
		...
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		baseDao.deleteByWhere(xmProjectMBudgetCostNouser);
		//Assert.assertEquals(1, result);
	}
	...
	public void deleteByPk() {
		...
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		baseDao.deleteByPk(xmProjectMBudgetCostNouser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		baseDao.updateSomeFieldByPk(xmProjectMBudgetCostNouser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateByPk() {
		Map<String,Object> p=BaseUtils.map("id","6TJJ");
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		baseDao.updateByPk(xmProjectMBudgetCostNouser);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("projectId","a9ls","budgetCost",9055.6,"id","6TJJ","remark","q8PA","subjectId","0bc9","bizzStartDate",parse("2020-09-28 15:48:44"),"bizzEndDate",parse("2020-09-28 15:48:44"),"bizProcInstId","xzav","bizFlowState","r","projectPhaseId","kcmN","costType","4","bizzMonth","4Ukt");
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		baseDao.insertOrUpdate(xmProjectMBudgetCostNouser);
		//Assert.assertEquals(1, result);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","6TJJ");
		Map<String,Object> result=this.baseDao.selectOne(XmProjectMBudgetCostNouser.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("projectId","a9ls","budgetCost",9055.6,"remark","q8PA","subjectId","0bc9","bizzStartDate",parse("2020-09-28 15:48:44"),"bizzEndDate",parse("2020-09-28 15:48:44"),"bizProcInstId","xzav","bizFlowState","r","projectPhaseId","kcmN","costType","4","bizzMonth","4Ukt");
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		long result=baseDao.countByWhere(xmProjectMBudgetCostNouser);
	...
	public void selectListByPage() {
		...
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=BaseUtils.fromMap(p,XmProjectMBudgetCostNouser.class);
		List<XmProjectMBudgetCostNouser> result=baseDao.selectListByWhere(xmProjectMBudgetCostNouser); 
	...
	public void selectListMapByWhere() {
		Map<String,Object> p=BaseUtils.map("projectId","a9ls","budgetCost",9055.6,"remark","q8PA","subjectId","0bc9","bizzStartDate",parse("2020-09-28 15:48:44"),"bizzEndDate",parse("2020-09-28 15:48:44"),"bizProcInstId","xzav","bizFlowState","r","projectPhaseId","kcmN","costType","4","bizzMonth","4Ukt");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectMBudgetCostNouser.class.getName()+".selectListMapByWhere",p);
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("projectId","a9ls","budgetCost",9055.6,"remark","q8PA","subjectId","0bc9","bizzStartDate",parse("2020-09-28 15:48:44"),"bizzEndDate",parse("2020-09-28 15:48:44"),"bizProcInstId","xzav","bizFlowState","r","projectPhaseId","kcmN","costType","4","bizzMonth","4Ukt");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectMBudgetCostNouser.class.getName()+".selectListMapByKey",p);
		Assert.assertEquals(true, result.size()>=0);
	}
	...
	public void selectOneObject() {
		...
		XmProjectMBudgetCostNouser xmProjectMBudgetCostNouser=baseDao.selectOneObject(xmProjectMBudgetCostNouser1);
