 ...
 ***/
 ...
 @SpringBootTest
public class TestXmProjectGroupUserDao  {
	...
	public void insert() {
		...
		baseDao.insert(xmProjectGroupUser);
	...
	public void deleteByWhere() {
		...
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		baseDao.deleteByWhere(xmProjectGroupUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void deleteByPk() {
		...
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		baseDao.deleteByPk(xmProjectGroupUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		baseDao.updateSomeFieldByPk(xmProjectGroupUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateByPk() {
		Map<String,Object> p=BaseUtils.map("id","CHFR");
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		baseDao.updateByPk(xmProjectGroupUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("joinTime",parse("2020-11-11 18:53:27"),"id","CHFR","groupId","UAmB","userid","ZiPZ","username","IxVu","isHead","G","outTime",parse("2020-11-11 18:53:27"),"status","y","bizProcInstId","5AiW","bizFlowState","R","projectId","H6Ue");
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		baseDao.insertOrUpdate(xmProjectGroupUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","CHFR");
		Map<String,Object> result=this.baseDao.selectOne(XmProjectGroupUser.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("joinTime",parse("2020-11-11 18:53:27"),"groupId","UAmB","userid","ZiPZ","username","IxVu","isHead","G","outTime",parse("2020-11-11 18:53:27"),"status","y","bizProcInstId","5AiW","bizFlowState","R","projectId","H6Ue");
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		long result=baseDao.countByWhere(xmProjectGroupUser);
	...
	public void selectListByPage() {
		...
		XmProjectGroupUser xmProjectGroupUser=BaseUtils.fromMap(p,XmProjectGroupUser.class);
		List<XmProjectGroupUser> result=baseDao.selectListByWhere(xmProjectGroupUser); 
	...
	public void selectListMapByWhere() {
		Map<String,Object> p=BaseUtils.map("joinTime",parse("2020-11-11 18:53:27"),"groupId","UAmB","userid","ZiPZ","username","IxVu","isHead","G","outTime",parse("2020-11-11 18:53:27"),"status","y","bizProcInstId","5AiW","bizFlowState","R","projectId","H6Ue");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectGroupUser.class.getName()+".selectListMapByWhere",p);
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("joinTime",parse("2020-11-11 18:53:27"),"groupId","UAmB","userid","ZiPZ","username","IxVu","isHead","G","outTime",parse("2020-11-11 18:53:27"),"status","y","bizProcInstId","5AiW","bizFlowState","R","projectId","H6Ue");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectGroupUser.class.getName()+".selectListMapByKey",p);
		Assert.assertEquals(true, result.size()>=0);
	}
	...
	public void selectOneObject() {
		...
		XmProjectGroupUser xmProjectGroupUser=baseDao.selectOneObject(xmProjectGroupUser1);
