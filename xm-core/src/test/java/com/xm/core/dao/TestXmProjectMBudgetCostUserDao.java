...
/**
 * XmProjectMBudgetCostUserDao的测试案例
 * 组织 com.qqkj<br>
 * 顶级模块 oa<br>
 * 大模块 xm<br>
 * 小模块 <br>
 ...
 ***/
 ...
 @SpringBootTest
public class TestXmProjectMBudgetCostUserDao  {
	...
	public void insert() {
		...
		baseDao.insert(xmProjectMBudgetCostUser);
	...
	public void deleteByWhere() {
		...
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		baseDao.deleteByWhere(xmProjectMBudgetCostUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void deleteByPk() {
		...
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		baseDao.deleteByPk(xmProjectMBudgetCostUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		baseDao.updateSomeFieldByPk(xmProjectMBudgetCostUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateByPk() {
		Map<String,Object> p=BaseUtils.map("id","zARB");
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		baseDao.updateByPk(xmProjectMBudgetCostUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("projectId","aH71","userid","5R6l","budgetCost",2842.17,"id","zARB","remark","FVK0","username","Sp7K","subjectId","8ONu","bizzStartDate",parse("2020-09-28 15:48:47"),"bizzEndDate",parse("2020-09-28 15:48:47"),"bizzMonth","KG3H","bizProcInstId","sUMB","bizFlowState","0","projectPhaseId","mg6S","costType","E");
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		baseDao.insertOrUpdate(xmProjectMBudgetCostUser);
		//Assert.assertEquals(1, result);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","zARB");
		Map<String,Object> result=this.baseDao.selectOne(XmProjectMBudgetCostUser.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("projectId","aH71","userid","5R6l","budgetCost",2842.17,"remark","FVK0","username","Sp7K","subjectId","8ONu","bizzStartDate",parse("2020-09-28 15:48:47"),"bizzEndDate",parse("2020-09-28 15:48:47"),"bizzMonth","KG3H","bizProcInstId","sUMB","bizFlowState","0","projectPhaseId","mg6S","costType","E");
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		long result=baseDao.countByWhere(xmProjectMBudgetCostUser);
	...
	public void selectListByPage() {
		...
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=BaseUtils.fromMap(p,XmProjectMBudgetCostUser.class);
		List<XmProjectMBudgetCostUser> result=baseDao.selectListByWhere(xmProjectMBudgetCostUser); 
	...
	public void selectListMapByWhere() {
		Map<String,Object> p=BaseUtils.map("projectId","aH71","userid","5R6l","budgetCost",2842.17,"remark","FVK0","username","Sp7K","subjectId","8ONu","bizzStartDate",parse("2020-09-28 15:48:47"),"bizzEndDate",parse("2020-09-28 15:48:47"),"bizzMonth","KG3H","bizProcInstId","sUMB","bizFlowState","0","projectPhaseId","mg6S","costType","E");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectMBudgetCostUser.class.getName()+".selectListMapByWhere",p);
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("projectId","aH71","userid","5R6l","budgetCost",2842.17,"remark","FVK0","username","Sp7K","subjectId","8ONu","bizzStartDate",parse("2020-09-28 15:48:47"),"bizzEndDate",parse("2020-09-28 15:48:47"),"bizzMonth","KG3H","bizProcInstId","sUMB","bizFlowState","0","projectPhaseId","mg6S","costType","E");
		List<Map<String,Object>> result=baseDao.selectList(XmProjectMBudgetCostUser.class.getName()+".selectListMapByKey",p);
		Assert.assertEquals(true, result.size()>=0);
	}
	...
	public void selectOneObject() {
		...
		XmProjectMBudgetCostUser xmProjectMBudgetCostUser=baseDao.selectOneObject(xmProjectMBudgetCostUser1);
