 ...
 ***/
 ...
 @SpringBootTest
public class TestXmQuestionTagDao  {
	...
	public void deleteByWhere() {
		...
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		baseDao.deleteByWhere(xmQuestionTag);
		//Assert.assertEquals(1, result);
	}
	...
	public void deleteByPk() {
		...
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		baseDao.deleteByPk(xmQuestionTag);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		baseDao.updateSomeFieldByPk(xmQuestionTag);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateByPk() {
		Map<String,Object> p=BaseUtils.map("id","jfME");
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		baseDao.updateByPk(xmQuestionTag);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("questionId","MsQw","tagId","oc42","tagName","YNqd","ctime",parse("2020-10-15 15:31:20"),"id","jfME");
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		baseDao.insertOrUpdate(xmQuestionTag);
		//Assert.assertEquals(1, result);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","jfME");
		Map<String,Object> result=this.baseDao.selectOne(XmQuestionTag.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("questionId","MsQw","tagId","oc42","tagName","YNqd","ctime",parse("2020-10-15 15:31:20"));
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		long result=baseDao.countByWhere(xmQuestionTag);
	...
	public void selectListByPage() {
		...
		XmQuestionTag xmQuestionTag=BaseUtils.fromMap(p,XmQuestionTag.class);
		List<XmQuestionTag> result=baseDao.selectListByWhere(xmQuestionTag); 
	...
	public void selectListMapByWhere() {
		Map<String,Object> p=BaseUtils.map("questionId","MsQw","tagId","oc42","tagName","YNqd","ctime",parse("2020-10-15 15:31:20"));
		List<Map<String,Object>> result=baseDao.selectList(XmQuestionTag.class.getName()+".selectListMapByWhere",p);
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("questionId","MsQw","tagId","oc42","tagName","YNqd","ctime",parse("2020-10-15 15:31:20"));
		List<Map<String,Object>> result=baseDao.selectList(XmQuestionTag.class.getName()+".selectListMapByKey",p);
		Assert.assertEquals(true, result.size()>=0);
	}
	...
	public void selectOneObject() {
		...
		XmQuestionTag xmQuestionTag=baseDao.selectOneObject(xmQuestionTag1);
