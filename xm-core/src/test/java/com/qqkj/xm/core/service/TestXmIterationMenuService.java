...
@SpringBootTest
public class TestXmIterationMenuService  {

	@Autowired
	XmIterationMenuService xmIterationMenuService;
	...
	public void deleteByWhere() {
		...
		XmIterationMenu xmIterationMenu=BaseUtils.fromMap(p,XmIterationMenu.class);
		xmIterationMenuService.deleteByWhere(xmIterationMenu);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		xmIterationMenuService.updateSomeFieldByPk(xmIterationMenu);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("id","8b59","iterationId","5b38","menuId","Se4e","productId","oIgA","ctime",parse("2020-11-07 22:55:27"),"relStatus","x","hasTask","9","cuserid","itag","cusername","cxXF");
		XmIterationMenu xmIterationMenu=BaseUtils.fromMap(p,XmIterationMenu.class);
		xmIterationMenuService.insertOrUpdate(xmIterationMenu);
		//Assert.assertEquals(1, result);
	}
	...
	public void batchUpdate() {
		...
		xmIterationMenuService.batchUpdate(batchValues);
	...
	public void batchDelete() {
		...
		XmIterationMenu xmIterationMenu7=BaseUtils.fromMap(p7,XmIterationMenu.class);
		batchValues.add(xmIterationMenu7);
		xmIterationMenuService.batchDelete(batchValues);
		//Assert.assertEquals(1, result[0]);
	}
	...
	public void batchInsert() {
		...
		XmIterationMenu xmIterationMenu7=BaseUtils.fromMap(p7,XmIterationMenu.class);
		batchValues.add(xmIterationMenu7);
		xmIterationMenuService.batchInsert(batchValues);
		//Assert.assertEquals(1, result[0]);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","8b59");
		Map<String,Object> result=this.xmIterationMenuService.selectOne(XmIterationMenu.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("iterationId","5b38","menuId","Se4e","productId","oIgA","ctime",parse("2020-11-07 22:55:27"),"relStatus","x","hasTask","9","cuserid","itag","cusername","cxXF");
		XmIterationMenu xmIterationMenu=BaseUtils.fromMap(p,XmIterationMenu.class);
		long result=xmIterationMenuService.countByWhere(xmIterationMenu);
	...
	public void selectListByPage() {
		...
		XmIterationMenu xmIterationMenu=BaseUtils.fromMap(p,XmIterationMenu.class);
		List<XmIterationMenu> result=xmIterationMenuService.selectListByWhere(xmIterationMenu); 
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("iterationId","5b38","menuId","Se4e","productId","oIgA","ctime",parse("2020-11-07 22:55:27"),"relStatus","x","hasTask","9","cuserid","itag","cusername","cxXF");
		List<Map<String,Object>> result=xmIterationMenuService.selectListMapByKey(p);
	...
	public void selectOneObject() {
		...
		XmIterationMenu xmIterationMenu=xmIterationMenuService.selectOneObject(xmIterationMenu1);
