...
@SpringBootTest
public class TestXmProjectGroupFormworkService  {

	@Autowired
	XmProjectGroupFormworkService xmProjectGroupFormworkService;
	...
	public void deleteByWhere() {
		...
		XmProjectGroupFormwork xmProjectGroupFormwork=BaseUtils.fromMap(p,XmProjectGroupFormwork.class);
		xmProjectGroupFormworkService.deleteByWhere(xmProjectGroupFormwork);
		//Assert.assertEquals(1, result);
	}
	...
	public void updateSomeFieldByPk() {
		...
		xmProjectGroupFormworkService.updateSomeFieldByPk(xmProjectGroupFormwork);
		//Assert.assertEquals(1, result);
	}
	...
	public void insertOrUpdate() {
		Map<String,Object> p=BaseUtils.map("id","vnXu","branchId","5HBp","groupName","yefQ","isPub","4","pgTypeId","Q6tZ","pgTypeName","HHT0");
		XmProjectGroupFormwork xmProjectGroupFormwork=BaseUtils.fromMap(p,XmProjectGroupFormwork.class);
		xmProjectGroupFormworkService.insertOrUpdate(xmProjectGroupFormwork);
		//Assert.assertEquals(1, result);
	}
	...
	public void batchUpdate() {
		...
		xmProjectGroupFormworkService.batchUpdate(batchValues);
	...
	public void batchDelete() {
		...
		XmProjectGroupFormwork xmProjectGroupFormwork7=BaseUtils.fromMap(p7,XmProjectGroupFormwork.class);
		batchValues.add(xmProjectGroupFormwork7);
		xmProjectGroupFormworkService.batchDelete(batchValues);
		//Assert.assertEquals(1, result[0]);
	}
	...
	public void batchInsert() {
		...
		XmProjectGroupFormwork xmProjectGroupFormwork7=BaseUtils.fromMap(p7,XmProjectGroupFormwork.class);
		batchValues.add(xmProjectGroupFormwork7);
		xmProjectGroupFormworkService.batchInsert(batchValues);
		//Assert.assertEquals(1, result[0]);
	}
	...
	public void selectOneMap() {
		Map<String,Object> p=BaseUtils.map("id","vnXu");
		Map<String,Object> result=this.xmProjectGroupFormworkService.selectOne(XmProjectGroupFormwork.class.getName()+".selectOneMap",p);
	...
	public void countByWhere() {
		Map<String,Object> p=BaseUtils.map("branchId","5HBp","groupName","yefQ","isPub","4","pgTypeId","Q6tZ","pgTypeName","HHT0");
		XmProjectGroupFormwork xmProjectGroupFormwork=BaseUtils.fromMap(p,XmProjectGroupFormwork.class);
		long result=xmProjectGroupFormworkService.countByWhere(xmProjectGroupFormwork);
	...
	public void selectListByPage() {
		...
		XmProjectGroupFormwork xmProjectGroupFormwork=BaseUtils.fromMap(p,XmProjectGroupFormwork.class);
		List<XmProjectGroupFormwork> result=xmProjectGroupFormworkService.selectListByWhere(xmProjectGroupFormwork); 
	...
	public void selectListMapByKey() {
		Map<String,Object> p=BaseUtils.map("branchId","5HBp","groupName","yefQ","isPub","4","pgTypeId","Q6tZ","pgTypeName","HHT0");
		List<Map<String,Object>> result=xmProjectGroupFormworkService.selectListMapByKey(p);
	...
	public void selectOneObject() {
		...
		XmProjectGroupFormwork xmProjectGroupFormwork=xmProjectGroupFormworkService.selectOneObject(xmProjectGroupFormwork1);
